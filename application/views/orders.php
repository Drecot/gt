            ...
            <nav class="navbar navbar-default" id="title" >
               <div class="container">
                  ...
                  <div class="collapse navbar-collapse" id="bs-navbar-collapse">
                     ...
                     <li><a href="#xaccount" class=" fa fa-user-o" onclick="toggle_visibility('myForm');">  Hi, <b><?php if (isset($_SESSION['user'])){ echo $_SESSION['firstname']; } else {echo "Login"; }?></b> <i class="fa fa-caret-down"></i></a></li>
                     <div class=" form-popup" id="myForm">
                        <div id="defaultOpen1" class="">
