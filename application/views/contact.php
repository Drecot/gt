...
>>>>>>> 24eb2c8bf7d5f410d10bb3077b678fbc477dd7de
            ...
            <div class="track-outer text-center" id="track" style="display:block;">
                ...
                <div class="track-inner">
                    ...
                    <h1>TRACK ORDER</h1>
                    	...
                    	<div class="track-2">
            <div class="">
                <input class="track" type="text" name="email" id="" title="Enter Tracking Number"placeholder="Enter Tracking Number" >
            </div>
            <div class="">
                <button type="submit" title="Track Order" class="button" onclick="toggle_visibility('track');toggle_visibility('tracking');">
 ...
 --><li class="progtrckr-todo">Delivered</li>
                    ...
                    <div class="">
                <button type="submit" title="Track Order" class="button1" onclick="toggle_visibility('track');toggle_visibility('tracking');">
