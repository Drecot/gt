							...
							<div class="collapse navbar-collapse" id="bs-navbar-collapse">
								<ul class="nav navbar-nav main-navbar-nav">
									...
									<li><a href="#xaccount" class=" fa fa-user-o" onclick="toggle_visibility('myForm');">
											<?php if (isset($_SESSION['user'])){ echo $_SESSION['firstname']; } else {echo "Login"; }?></a></li>
									<!-- <Form housing login and signup dropdown> -->
									<div class=" form-popup" id="myForm">
										<!-- <login Dropdown> -->
										<div id="defaultOpen1" class="">
...
>>>>>>> 93de756702e1c87531d8210dc16d7262c9bc7701
			                     { 
							...
							<div class="form-group ">
								<label for="phonenumber"><b>Phone Number</b></label>
								<input id="number" type="tel" placeholder="Enter Phone Number" name="phonenumber" minlength="11" maxlength="11"
								 required>
								<span class="help-block"></span>
							</div>
							...
							<div class="form-group ">
								<label for="password"><b>Password</b></label>
								<input class="pass" id="password" type="password" placeholder="Enter Password" name="password" minlength="8"
								 required>
								<span class="help-block"></span>
							</div>
							<div class="form-group ">
								<p id="no_match" style="color: brown; text-align: center; display: none;">Passwords do not match</p>
								<label for="confirm_password"><b>Confirm Password</b></label>
								<input class="pass" id="cpassword" type="password" placeholder="Confirm Password" name="confirm_password"
			...
			<script>
				$(document).ready(function () {
					...
					$('input').keyup(function () {
						...
						if ($.trim($("#firstname").val()) && $.trim($("#lastname").val()) && $.trim($("#email").val()) && $.trim($(
