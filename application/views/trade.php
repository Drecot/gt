                 ...
                 <div class="" style="margin: auto">
					...
					<div id="myCarousel" class="carousel slide"  style="margin: auto">
						...
						<div class="item active">
								...
								<div class="game-box1" >
									<div class="game-picture1">
                                                                            <img src="img/xbox1/fifa17.jpg" alt="Fifa 17" width="100%" height="100%">
									</div>
						...
						<div class="item">
								...
								<div class="  game-box1">
									<div class="game-picture1">
                                                                            <img src="img/xbox1/cod-legacy.jpg" alt="Cod-Legacy" width="100%" height="100%">
									</div>
									<div class="game-name1">
						...
						<div class=" " style="margin: auto; float: none;">
								<div class=" game-box1">
									<div class="game-picture1">
                                                                            <img src="img/xbox1/rainbowsix.jpg" alt="Rainbow Six" width="100%" height="100%">
									</div>
									<div class="game-name1">
  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    ...
    <span class="sr-only">Next</span>
                     ...
                     <div class=" text-center">
                        ...
                        <button type="submit" title="Add Another Game" class="button" data-toggle="modal" data-target="#myModal1" style=" width: 50%; background: black; opacity: 0.8; border-radius: 100px ">
