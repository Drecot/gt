						...
						<div class="navbar-header">
                            <div class="container">
                                ...
                                <a href="index.php" class="navbar-brand brand-logo">
                                    <img src="img/logo.png" srcset="img/logo2.png 2x, img/logo3.png 3x" alt="Post"
						...
						<ul class="header-cart-wrapitem">
										<li class="header-cart-item">
											<div class="header-cart-item-img">
												<img src="img/wishlist/item-01.jpg" alt="IMG">
											</div>
							...
							<ul class="nav navbar-nav main-navbar-nav">
								...
								<div class="form-popup" id="myCart">
									...
									<ul class="header-cart-wrapitem">
													<li class="header-cart-item">
														<div class="header-cart-item-img">
															<img src="img/cart/item-01.jpg" alt="IMG">
														</div>
        ...
        <section style=" background: white; padding-bottom: 100px; padding-top: 50px;" >
            ...
            <div class="container  " style=" margin-bottom: 50px; ">
                ...
                <div class="col-sm-6 " style="  text-align: right;">
                    ...
                    <p style=" line-height: 2">GameTrade.ng started out as a random idea, trying to solve the problem of an individual. That same idea now serves thousands of individuals in Nigeria.
                        We thought about how to make it easier for gamers in this part of the world to acquire games, from the convenience of their homes and at a much cheaper price or possibly for free. 
                        Yes for free! A lot of people dump games they are done playing in their houses, after buying them for quite a lot of money. For hardcore gamers, it can take a day to complete a single disk.
                        Pellentesque congue ac orci ut gravida. Aliquam erat volutpat. Donec iaculis lectus a arcu facilisis, eu sodales lectus sagittis. Etiam pellentesque,
                        magna vel dictum rutrum, neque justo eleifend elit, vel tincidunt erat arcu ut sem. Sed rutrum, turpis ut commodo efficitur, quam velit convallis ipsum,
			...
			<a href="#x" class="pad fa fa-twitter"></a>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 fbox" >
                    <h4>HELP</h4>
                     ...
                     <p><a href="#xdelivery"> Delivery</a></p>
