...
<html lang="en">
   ...
   <body>
        ...
        <section class="container" style="background-color:lightgrey; padding-bottom: 100px; padding-top: 50px;">
            ...
            <div class="col-md-2 rd-2 white float-left">
                ...
                <div>
                  ...
                  <a href="#x" class="f12px">Account Information</a><br>
                  <a href="#x" class="f12px">Delivery Address</a>
                </div>
                ...
                <h3><i class="fa fa-shopping-bag fa-2x"></i> My Orders</h3>
                  <div>
                  <a href="#x" class="f12px">Orders</a><br>
      ...
      <option value="other">Other</option>
                  ...
                  <div class="col-md-3 mr-15 mt-30 mb-30 float-right">
