                ...
                <div class="container-fluid">
                    ...
                    <div class="col-md-2 new ">
                        <div class=" game-box">
                            ...
                            <div class="game-name">
                                <i class="fa fa-heart-o wishlistpointer" title="Add to wishlist" data-toggle="modal"
                                    data-target="#wishlistModal"></i>
                            ...
                            <div class=" game-info" style="width: 100%;">
                                ...
                                <div class="add" style=" float: left">
                                    <button class="game-button btn" data-toggle="modal" data-target="#cartModal"><i
                                            class=""></i></button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-2 used">
                        <div class="game-box">
                            <div class="game-picture">
                                <img src="assets/img/xbox1/theevilwithin.jpg" alt="The Evil Within" width="100%"
                                    height="100%">
                            </div>
                            <div class="game-name">
                                <i class="fa fa-heart-o wishlistpointer" title="Add to wishlist" data-toggle="modal"
